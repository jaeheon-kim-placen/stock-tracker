    ...
    return (
      <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
        <div className="bg-gray-900 rounded-2xl p-8 w-full max-w-md border border-gray-800 text-center">
          ...
          <h2 className="text-xl font-bold text-white mb-2">ê°€??? ì²­ ?„ë£Œ!</h2>
          <p className="text-gray-400 text-sm">ê´€ë¦¬ì ?¹ì¸ ??ë¡œê·¸?¸í•˜?????ˆìŠµ?ˆë‹¤.</p>
  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="bg-gray-900 rounded-2xl p-8 w-full max-w-md border border-gray-800">
        ...
        <p className="text-gray-400 mb-8">?Œì›ê°€??? ì²­</p>
